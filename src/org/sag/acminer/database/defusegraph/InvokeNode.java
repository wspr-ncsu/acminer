...
@XStreamAlias("InvokeNode")
public class InvokeNode extends Node implements IInvokeNode {
	...
	public InvokeNode(SootMethod source, Unit unit, SootMethod target, Identifier identifier) {
	...
	@Override
	public InvokeNode readXML(String filePath, Path path) throws Exception {
		return XStreamInOut.readXML(this, filePath, path);
	}
	
	@Override
	public boolean equals(Object o) {
		if(super.equals(o) && o instanceof InvokeNode) {
			return Objects.equals(target, ((InvokeNode)o).target);
		}
		return false;
	}
	...
	public int compareTo(INode o) {
		...
		if(ret == 0)
			ret = SootSort.smComp.compare(target, ((InvokeNode)o).target);
		return ret;
	}
