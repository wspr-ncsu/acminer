...
@XStreamAlias("FieldNode")
public class FieldNode extends Node implements IFieldNode {
	...
	public FieldNode(SootMethod source, Unit unit, SootField field, Identifier identifier) {
	...
	@Override
	public FieldNode readXML(String filePath, Path path) throws Exception {
		return XStreamInOut.readXML(this, filePath, path);
	}
	
	@Override
	public boolean equals(Object o) {
		if(super.equals(o) && o instanceof FieldNode) {
			return Objects.equals(field, ((FieldNode)o).field);
		}
		return false;
	}
	...
	public int compareTo(INode o) {
		...
		if(ret == 0)
			ret = SootSort.sfComp.compare(field, ((FieldNode)o).field);
		return ret;
	}
