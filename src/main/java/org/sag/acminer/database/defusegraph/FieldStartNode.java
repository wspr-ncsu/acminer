...
@XStreamAlias("FieldStartNode")
public class FieldStartNode extends StartNode implements IFieldNode {
	...
	public FieldStartNode(SootMethod source, Unit unit, SootField field, Identifier identifier) {
	...
	protected Object readResolve() throws ObjectStreamException {
		...
		if(fieldContainer != null)
			field = fieldContainer.toSootField();
		else
			field = null;
		return this;
	}
	...
	@Override
	public FieldStartNode readXML(String filePath, Path path) throws Exception {
		return XStreamInOut.readXML(this, filePath, path);
	}
	
	@Override
	public boolean equals(Object o) {
		if(super.equals(o) && o instanceof FieldStartNode) {
			return Objects.equals(field, ((FieldStartNode)o).field);
		}
		return false;
	}
	...
	public int compareTo(INode o) {
		...
		if(ret == 0)
			ret = SootSort.sfComp.compare(field, ((FieldStartNode)o).field);
		return ret;
	}
