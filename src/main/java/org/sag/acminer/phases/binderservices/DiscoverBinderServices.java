...
public class DiscoverBinderServices {
	...
	private List<String> tempAddSystemServiceSigs = ImmutableList.of(
		...
		"<android.os.ServiceManager: void addService(java.lang.String,android.os.IBinder,boolean,int)>",
		...
		"<android.os.ServiceManagerProxy: void addService(java.lang.String,android.os.IBinder,boolean,int)>",
		"<android.os.ServiceManagerNative: void addService(java.lang.String,android.os.IBinder,boolean)>",
		"<android.os.ServiceManagerNative: void addService(java.lang.String,android.os.IBinder,boolean,int)>",
		...
		//Samsung methods
		"<com.android.server.enterprise.EnterpriseDeviceManagerService$Injector: void addSystemService(java.lang.String,android.os.IBinder)>", 
		"<com.android.server.enterprise.billing.EnterpriseBillingPolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>", 
		"<com.android.server.enterprise.container.KnoxMUMRCPPolicyService: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.nap.NetworkAnalyticsService: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.restriction.SPDControlPolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.scep.EnterpriseCertEnrollPolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.shareddevice.EnterpriseSharedDevicePolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.smartcard.SmartCardBrowserPolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.smartcard.SmartCardEmailPolicy: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.enterprise.sso.GenericSSOService: void notifyToAddSystemService(java.lang.String,android.os.IBinder)>",
		"<com.android.server.inputmethod.InputMethodManagerService: void addServiceForDirectPenInput(java.lang.String,android.os.IBinder)>",
		"<android.view.inputmethod.InputMethodManager: void addServiceForDirectPenInput(android.content.Context,java.lang.String,android.os.IBinder)>"
	);
	...
	private List<String> tempGetSystemServiceSigs = ImmutableList.of(
		...
		"<android.os.ServiceManager: android.os.IBinder rawGetService(java.lang.String)>",
	...
	// Methods that contain a invoke statement from the tempAddSystemServiceSigs but we are ignoring because the name of the 
	// service or IBinder class cannot be resolved using static analysis (added because Samung)
	private List<String> skipSourceOfAddSystemServiceSigs = ImmutableList.of(
		"<com.android.internal.view.IInputMethodManager$Stub: boolean onTransact(int,android.os.Parcel,android.os.Parcel,int)>",
		"<com.android.server.enterprise.EnterpriseDeviceManagerService: void notifyAddSystemService()>"
	);
	
	private List<String> skipSourceOfGetSystemServiceSigs = ImmutableList.of();
	...
	public Map<SootClass,Map<SootClass,Set<Quad<String,SootMethod,Unit,Boolean>>>> run() {
		...
		Map<SootMethod,Set<Stmt>> sourceToInvokeStmt = getInvokeStmtsOfSigs(resolveMethodsGivenSignatures(tempAddSystemServiceSigs), 
				resolveMethodsGivenSignatures(skipSourceOfAddSystemServiceSigs));
			...
			for(Stmt u : sourceToInvokeStmt.get(sm)) {
				...
				if(nameArg instanceof StringConstant) {
					...
					throw new RuntimeException("Error: Unhandled value type '" + nameArg.getClass().toString() 
						+ "' for '" + nameArg.toString() + "' when evaluating the name argument in '" + sm.getSignature() + "'.");
				}
				...
				for(DefinitionStmt def : defs) {
					...
					if(right instanceof ParameterRef) {
						...
						} else if(ref.getSignature().toString().equals("<java.lang.reflect.Constructor: java.lang.Object newInstance(java.lang.Object[])>")) {
							// This was added to resolve the IBinder object type when reflection is used in Samsung devices
							Set<DefinitionStmt> constructorDefs = defsFinder.getDefsWithAliasesAndArraysRemoveLocalAndCastAndArrays(
									(Local)(((soot.jimple.InstanceInvokeExpr)right).getBase()), def);
							for(DefinitionStmt constructorDef : constructorDefs) {
								Value constructorDefRight = constructorDef.getRightOp();
								if(constructorDefRight instanceof InvokeExpr && ((InvokeExpr)constructorDefRight).getMethodRef().getSignature().toString()
										.equals("<java.lang.Class: java.lang.reflect.Constructor getConstructor(java.lang.Class[])>")) {
									Set<DefinitionStmt> loaderDefs = defsFinder.getDefsWithAliasesAndArraysRemoveLocalAndCastAndArrays(
											(Local)(((soot.jimple.InstanceInvokeExpr)constructorDefRight).getBase()), constructorDef);
									for(DefinitionStmt loaderDef : loaderDefs) {
										Value loaderDefRight = loaderDef.getRightOp();
										if(loaderDefRight instanceof InvokeExpr) {
											String loaderDefSig = ((InvokeExpr)loaderDefRight).getMethodRef().getSubSignature().toString();
											if(loaderDefSig.equals("java.lang.Class loadClass(java.lang.String)") 
													|| loaderDefSig.equals("java.lang.Class forName(java.lang.String)")) {
												Value serviceClassArg = ((InvokeExpr)loaderDefRight).getArg(0);
												String serviceClassName;
												if(serviceClassArg instanceof StringConstant) {
													serviceClassName = ((StringConstant)serviceClassArg).value;
												} else {
													throw new RuntimeException("Error: Unhandled value type for reflection string class name when resolving IBinder type.\n"
														+ "  ServiceClassArgType: " + serviceClassArg.getClass().toString() + "\n"
														+ "  ServiceClassArg:     " + serviceClassArg.toString() + "\n"
														+ "  LoaderDef:           " + loaderDef + "\n"
												...
												servicesRegistered.add(Scene.v().getSootClassUnsafe(serviceClassName, true));
											} else {
												throw new RuntimeException("Error: Unhandled invoke definition for reflection Constructor loader object when resolving IBinder type.\n"
													+ "  LoaderDef: " + loaderDef + "\n"
													+ "  ConstructorDef: " + constructorDef + "\n"
													+ "  Local:          " + l + "\n"
													+ "  Def:            " + def + "\n"
											...
											throw new RuntimeException("Error: Unhandled definition for reflection Constructor loader object when resolving IBinder type.\n"
												+ "  LoaderDef: " + loaderDef + "\n"
												+ "  ConstructorDef: " + constructorDef + "\n"
												+ "  Local:          " + l + "\n"
												+ "  Def:            " + def + "\n"
									...
									throw new RuntimeException("Error: Unhandled definition for reflection Constructor object when resolving IBinder type.\n"
										+ "  ConstructorDef: " + constructorDef + "\n"
										+ "  Local:          " + l + "\n"
										+ "  Def:            " + def + "\n"
										+ "  AddStmt:        " + u + "\n"
					...
					if(servicesRegistered.remove(ibinder)) {
						if(sourceToServiceGetStmts == null)
							sourceToServiceGetStmts = getInvokeStmtsOfSigs(resolveMethodsGivenSignatures(tempGetSystemServiceSigs), 
									resolveMethodsGivenSignatures(skipSourceOfGetSystemServiceSigs));
	...
	private Map<SootClass,Set<SootClass>> createStubToServicesMap(Set<SootClass> in) {
		...
		for(SootClass sc : in) {
			...
			//For those entry point stubs with no entry points that are still registered with the system server
			//Seems dumb but occurs in Samsung
			if(ret.isEmpty()) {
				//Not in the BinderGroups database and if it is in the EntryPoints database it has not entry points
				//and is just listed as a stub, so just add itself to the list
				Set<SootClass> services = ret.get(sc);
				if(services == null) {
					services = new HashSet<>();
					ret.put(sc, services);
				}
	...
	private static Map<SootMethod,Set<Stmt>> getInvokeStmtsOfSigs(Set<String> methodSigs, Set<String> skipSourceMethodSigs) {
		...
		for(SootClass sc : Scene.v().getClasses()) {
			...
			if(!hierarchyOfServiceManager.contains(sc)) {
				for(SootMethod sm : sc.getMethods()) {
					//Method has a body, is not one of the methods we are searching for calls too, and is not a method we determined to be un-resolvable
					if(sm.isConcrete() && !methodSigs.contains(sm.getSignature()) && !skipSourceMethodSigs.contains(sm.getSignature())) {
	...
	private SootField resolveFieldRef(FieldRef ref, SootMethod sm, Unit u) {
		if(ref instanceof StaticFieldRef) {
			return HierarchyHelpers.resolveField(ref.getFieldRef());
		} else {
			...
			return HierarchyHelpers.resolveField(Scene.v().makeFieldRef(finalType, ref.getFieldRef().name(), 
					ref.getFieldRef().type(), ref.getFieldRef().isStatic()));
		}
	}
